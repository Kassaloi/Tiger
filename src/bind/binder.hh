...
namespace bind
{
  ...
  protected:
    ...
    misc::scoped_map<misc::symbol, ast::TypeDec*> t_scope_;
    misc::scoped_map<misc::symbol, ast::FunctionDec*> f_scope_;
    misc::scoped_map<misc::symbol, ast::VarDec*> v_scope_;
    std::stack<ast::Exp*> l_scope_;
  };
